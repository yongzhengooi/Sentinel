    ...
    def garbage_collect(self, latest_time) -> None:
        ...
        for k in keys:
            ...
            if (
                ...
                if os.path.exists("{}\\cic_{}.txt".format(p,today)):
                    with open("{}\\cic_{}.txt".format(p,today), "a") as file:
                           file.write("\n")
                           file.write(str(data.values()))
                else:
                	with open("{}\\cic_{}.txt".format(p,today), "w") as file :
                           file.write(str(data.keys()))
